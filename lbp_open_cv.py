...
# alterar o local do arquivo de imagem
img = cv2.imread(r'C:\Users\Daniel SM\Downloads\happy.png', 0)

# mesmo endereço para cópia
transformed_img = cv2.imread(r'C:\Users\Daniel SM\Downloads\happy.png', 0)
